...
* 【2023-05-29】[vue-vine / vue-vine](https://github.com/vue-vine/vue-vine) - Another style of writing Vue components.
* 【2023-05-29】[Neo-Desktop / WindowsXPKg](https://github.com/Neo-Desktop/WindowsXPKg) - Keygen for Windows XP
* 【2023-05-29】[CodinGame / SpringChallenge2023](https://github.com/CodinGame/SpringChallenge2023) - https://www.codingame.com/contests/spring-challenge-2023
* 【2023-05-29】[ZeroMemoryEx / Blackout](https://github.com/ZeroMemoryEx/Blackout) - kill anti-malware protected processes (BYOVD)
...
* 【2023-05-26】[kreneskyp / ix](https://github.com/kreneskyp/ix) - Autonomous GPT-4 agent platform
* 【2023-05-26】[OpenGVLab / InternGPT](https://github.com/OpenGVLab/InternGPT) - InternGPT (iGPT) is an open source demo platform where you can easily showcase your AI models. Now it supports DragGAN, ChatGPT, ImageBind, multimodal chat like GPT-4, SAM, interactive image editing, etc. Try it at igpt.opengvlab.com (支持DragGAN、ChatGPT、ImageBind、SAM的在线Demo系统)
* 【2023-05-26】[Casualtek / Ransomchats](https://github.com/Casualtek/Ransomchats) - 
...
* 【2023-05-15】[jobrunr / jobrunr](https://github.com/jobrunr/jobrunr) - An extremely easy way to perform background processing in Java. Backed by persistent storage. Open and free for commercial use.
* 【2023-05-15】[springboot4 / Art](https://github.com/springboot4/Art) - 🎉后端基于Spring Boot 3.0、 Spring Cloud & Alibaba、Spring Authorization Server。 前端基于Vue3、Typescript等主流技术栈的微服务RBAC 、SaaS多租户系统。✨✨点个star➕关注更新。🍺🍺欢迎加入交流群。
...
* 【2023-05-29】[Occamsec / CVE-2023-2825](https://github.com/Occamsec/CVE-2023-2825) - GitLab CVE-2023-2825 PoC. This PoC leverages a path traversal vulnerability to retrieve the /etc/passwd file from a system running GitLab 16.0.0.
* 【2023-05-29】[SHI-Labs / Prompt-Free-Diffusion](https://github.com/SHI-Labs/Prompt-Free-Diffusion) - Prompt-Free Diffusion: Taking "Text" out of Text-to-Image Diffusion Models
* 【2023-05-29】[ShihaoZhaoZSH / Uni-ControlNet](https://github.com/ShihaoZhaoZSH/Uni-ControlNet) - 
* 【2023-05-29】[PanQiWei / AutoGPTQ](https://github.com/PanQiWei/AutoGPTQ) - An easy-to-use LLMs quantization package with user-friendly apis, based on GPTQ algorithm.
...
* 【2023-05-26】[LmeSzinc / StarRailCopilot](https://github.com/LmeSzinc/StarRailCopilot) - Star Rail auto script, bot | 星铁副驾驶，崩坏：星穹铁道脚本，基于下一代Alas框架
...
* 【2023-05-15】[yxlllc / DDSP-SVC](https://github.com/yxlllc/DDSP-SVC) - Real-time end-to-end singing voice conversion system based on DDSP (Differentiable Digital Signal Processing)
* 【2023-05-15】[IceClear / StableSR](https://github.com/IceClear/StableSR) - Exploiting Diffusion Prior for Real-World Image Super-Resolution
* 【2023-05-15】[J3ldo / UGC-Sniper](https://github.com/J3ldo/UGC-Sniper) - J3ldo Sniper, a free powerful, and easy to customize roblox Sniper
* 【2023-05-15】[csunny / DB-GPT](https://github.com/csunny/DB-GPT) - Interact your data and environment using the local GPT, no data leaks, 100% privately, 100% security
* 【2023-05-15】[widgetti / solara](https://github.com/widgetti/solara) - A Pure Python, React-style Framework for Scaling Your Jupyter and Web Apps
...
* 【2023-05-29】[github-20k / awesome-opensource](https://github.com/github-20k/awesome-opensource) - Best open-source GitHub libraries voted by members🎤
* 【2023-05-29】[raunofreiberg / interfaces](https://github.com/raunofreiberg/interfaces) - A non-exhaustive list of details that make a good web interface.
...
* 【2023-05-15】[pea-cake / tbk](https://github.com/pea-cake/tbk) - 淘宝客返利系统-网赚项目（nodejs）：1 .支持 淘宝、京东、拼多多转链 2.微信bot自动回复消息 转链、绑定订单 3.返利订单管理后台
* 【2023-05-15】[liangxin199045 / code-analysis-ts](https://github.com/liangxin199045/code-analysis-ts) - scan and analysis your typescript code, get a code report，help developers implement code merge interception / code alert
...
* 【2023-05-15】[apicat / apicat](https://github.com/apicat/apicat) - ApiCat is an API development tool based on AI technology. It analyzes and identifies API requirements input by users, and automatically generates corresponding API documents and codes to help developers develop APIs more quickly and efficiently.
...
* 【2023-05-15】[Korepi / Korepi](https://github.com/Korepi/Korepi) - Korek Api
...
* 【2023-05-26】[Azure-Samples / azure-search-openai-demo-csharp](https://github.com/Azure-Samples/azure-search-openai-demo-csharp) - A sample app for the Retrieval-Augmented Generation pattern running in Azure, using Azure Cognitive Search for retrieval and Azure OpenAI large language models to power ChatGPT-style and Q&A experiences.
...
* 【2023-05-15】[the-full-stack / website](https://github.com/the-full-stack/website) - Source for https://fullstackdeeplearning.com
* 【2023-05-15】[4xmen / Web-Package-RTL](https://github.com/4xmen/Web-Package-RTL) - Full RTL Package - Easy To Use By RTL Direction
* 【2023-05-15】[taikoxyz / taiko-mono](https://github.com/taikoxyz/taiko-mono) - A decentralized, Ethereum-equivalent ZK-Rollup.🥁
* 【2023-05-15】[sefyudem / 3D-Parallax-Website-in-JavaScript](https://github.com/sefyudem/3D-Parallax-Website-in-JavaScript) - 
...
* 【2023-05-26】[techaddict0x / presalewebsite](https://github.com/techaddict0x/presalewebsite) - presale & airdrop website bsc
* 【2023-05-26】[ConsenSys / doc.zk-evm](https://github.com/ConsenSys/doc.zk-evm) - zk-EVM documentation
...
* 【2023-05-30】[OpenGVLab / GITM](https://github.com/OpenGVLab/GITM) - 
* 【2023-05-29】[elliot-bia / nessus](https://github.com/elliot-bia/nessus) - nessus crack for docker
...
* 【2023-05-15】[sindresorhus / awesome-whisper](https://github.com/sindresorhus/awesome-whisper) - 🔊Awesome list for Whisper — an open-source AI-powered speech recognition system developed by OpenAI
