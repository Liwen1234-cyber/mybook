...
8.  Download the [Testnet database](https://download.chia.net/testnet11/blockchain_v2_testnet11.sqlite.gz) and place it in the `~/.chia/testnet11/db` folder.
...
3. Go to the [Testnet faucet](https://testnet11-faucet.chia.net) and give it your address.
