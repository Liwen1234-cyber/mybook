...
* 两个数组内存图
  ...
  ![](./images/数组内存分配-两个数组内存图.png)

* 多个数组指向相同内存图

  ![](./images/数组内存分配-多个数组指向一个数组内存图.png)
...
![](./images/Debug按键说明.png)

![](./images/Debug条件断点.png)
...
* Java1.8 以前的内存结构图：
  ![](./images/JVM-Java7内存结构图.png)

* Java1.8 之后的内存结果图：

  ![](./images/JVM-Java8内存结构图.png)
...
![](./images/JVM-ParallelScavenge收集器.png)
...
* **执行引擎**开始执行字节码
  ...
  * 这里小的数字都是和字节码指令存在一起，超过 short 范围的数字存入了常量池
  ...
  ![](./images/JVM-字节码执行流程3.png)

  `istore_3`：将操作数栈顶数据弹出，存入局部变量表的 slot 3

  `getstatic #4`：获取静态字段

  ![](./images/JVM-字节码执行流程4.png)

  `iload_3`：

  ![](./images/JVM-字节码执行流程5.png)
...
![](./images/Sort-归并排序.png)

归并步骤：每次比较两端最小的值，把最小的值放在辅助数组的左边

![](./images/Sort-归并步骤1.png)

![](./images/Sort-归并步骤2.png)

![](./images/Sort-归并步骤3.png)
...
* 删除节点：要删除节点12，先找到节点19，然后移动并替换节点12![](./images/Tree-二叉查找树删除节点.png)
...
![红黑树](./images/红黑树结构图.png)



红黑树添加节点的默认颜色为红色，效率高
![](./images/红黑树添加节点颜色.png)
...
![](./images/Tree-并查集存储结构.png)

合并方式：

![](./images/Tree-并查集合并.png)
...
![](./images/Tree-字典树构造过程1.png)

![](./images/Tree-字典树构造过程2.png)
