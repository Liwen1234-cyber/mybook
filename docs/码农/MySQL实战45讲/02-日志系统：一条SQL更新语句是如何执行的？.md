...
![](./images/16a7950217b3f0f4ed02db5db59562a7.png)
...
不对的地方，望大神指点</p>2018-11-16</li><br/><li><span>Godruoyi</span> 👍（275） 💬（58）<p>Bin log 用于记录了完整的逻辑记录，所有的逻辑记录在 bin log 里都能找到，所以在备份恢复时，是以 bin log 为基础，通过其记录的完整逻辑操作，备份出一个和原库完整的数据。
