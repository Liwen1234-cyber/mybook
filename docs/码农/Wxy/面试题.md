...
![](./images/java-thread-x-key-schronized-5.png)
...
![img](./images/整体 GC 问题普适的处理流程.jpg)

![img](./images/根因鱼骨图.png)
...
![](./images/9c0640bf9f01431cb2c6e4e5c635bfe2.png)
...
<img src="./images/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L05hYmFuZG9u,size_16,color_FFFFFF,t_70" alt="在这里插入图片描述" style="zoom:80%;" />
...
![](./images/网络发包收包全景图.png)

#### 26、UDP通信

![工作过程](./images/udp通信.png)
...
![](./images/MySQL两阶段提交.png)

![](./images/MySQL两阶段提交JavaGuide.png)
...
![image-20230218173550681](./images/MySQL主从库.png)
...
![img](./images/redis-master-slave-distributed-lock.ccc5be73.png)
...
![image-20230318153007369](./images/Redis通信模型.png)
...
![1653575176451](./images/list消息队列.png)
...
![1653575506373](./images/pubsub消息队列.png)
...
![](./images/R[0GLDZ2AXY(1AM[MLQ1~8A.png)
...
![img](./images/arch-z-transection-1.png)
...
![image-20230301161515900](./images/简单模式.png)
...
![image-20230301161322185](./images/工作队列模式.png)
...
![image-20230301161659697](./images/PubSub模式.png)
...
![image-20230301163019630](./images/Routing模式.png)
...
![image-20230301163745654](./images/Topic模式.png)
...
<img src="./images/selector" alt="image" style="zoom:80%;" />
...
<img src="./images/Von_Neumann_architecture.svg" alt="img" style="zoom:80%;" />
...
![分别为宏内核、微内核、混合内核的操作系统结构](./images/OS-structure2.png)
