...
<img src="./images/image-20210304105220371.png" alt="image-20210304105220371" style="zoom:67%;" />
...
<img src="./images/image-20210304110501797.png" alt="image-20210304110501797" style="zoom:50%;" />

​	我们可以观察一下红色的这一条曲线,它可以看作是**一个常数,再加上一群蓝色的这样子的 Function**,.

<img src="./images/image-20210305105846439.png" alt="image-20210305105846439" style="zoom:50%;" />
...
<img src="./images/image-20210305112252045.png" alt="image-20210305112252045" style="zoom: 50%;" />
...
<img src="./images/image-20210305125221397.png" alt="image-20210305125221397" style="zoom:50%;" />
...
<img src="./images/image-20210305125421864.png" alt="image-20210305125421864" style="zoom: 67%;" />
...
<img src="./images/image-20210305125845178.png" alt="image-20210305125845178" style="zoom:67%;" />
...
<img src="./images/image-20210305131705629.png" alt="image-20210305131705629" style="zoom:67%;" />
...
<img src="./images/image-20210305132035492.png" alt="image-20210305132035492" style="zoom:50%;" />
$$
y=c \frac{1}{1+e^{-(b+wx_1)}}
$$
...
<img src="./images/image-20210305134454023.png" alt="image-20210305134454023" style="zoom:50%;" />
...
<img src="./images/image-20210305135651731.png" alt="image-20210305135651731" style="zoom:50%;" />
...
<img src="./images/image-20210305135850892.png" alt="image-20210305135850892" style="zoom:50%;" />
...
<img src="./images/image-20210305143317386.png" alt="image-20210305143317386" style="zoom:50%;" />
...
<img src="./images/image-20210305144019248.png" alt="image-20210305144019248" style="zoom:50%;" />
...
<img src="./images/image-20210305144614449.png" alt="image-20210305144614449" style="zoom:67%;" />
...
<img src="./images/image-20210305144734507.png" alt="image-20210305144734507" style="zoom:67%;" />
...
<img src="./images/image-20210305145226366.png" alt="image-20210305145226366" style="zoom: 67%;" />

​	那把它改成线性代数比较常用的表示方式,x 乘上矩阵 w 再加上向量 b,会得到一个向量叫做 r



<img src="./images/image-20210305145835613.png" alt="image-20210305145835613" style="zoom:67%;" />
...
<img src="./images/image-20210305150100917.png" alt="image-20210305150100917" style="zoom:67%;" />
...
​	<img src="./images/image-20210305150004077.png" alt="image-20210305150004077" style="zoom:67%;" />
...
<img src="./images/image-20210305163408354.png" alt="image-20210305163408354" style="zoom:67%;" />
...
<img src="./images/image-20210305163500058.png" alt="image-20210305163500058" style="zoom:67%;" />

​	x 乘上 w 再加上 b 通过 Sigmoid Function,乘上 c 的 Transpose 加 b 就得到 y

​	接下来，怎麼把这些未知的参数找出来之前,我们先再稍微**重新定义一下我们的符号**,

<img src="./images/image-20210305163746820.png" alt="image-20210305163746820" style="zoom:67%;" />
...
<img src="./images/image-20210305205139367.png" alt="image-20210305205139367" style="zoom:50%;" />
...
<img src="./images/image-20210305212017162.png" alt="image-20210305212017162" style="zoom:50%;" />
...
<img src="./images/image-20210305212810760.png" alt="image-20210305212810760" style="zoom:50%;" />
...
θ^1 ← θ^0-ηg
$$
<img src="./images/image-20210305214435531.png" alt="image-20210305214435531" style="zoom:67%;" />
...
<img src="./images/image-20210305215349614.png" alt="image-20210305215349614" style="zoom: 50%;" />
...
<img src="./images/image-20210305215914525.png" alt="image-20210305215914525" style="zoom:50%;" />
...
​	<img src="./images/image-20210305220118548.png" alt="image-20210305220118548" style="zoom: 67%;" />
...
<img src="./images/image-20210305220759937.png" alt="image-20210305220759937" style="zoom: 67%;" />
...
<img src="./images/image-20210305221723518.png" alt="image-20210305221723518" style="zoom:67%;" />
...
​	<img src="./images/image-20210305222316873.png" alt="image-20210305222316873" style="zoom:50%;" />
...
<img src="./images/image-20210305222735833.png" alt="image-20210305222735833" style="zoom:50%;" />
...
<img src="./images/image-20210305223132264.png" alt="image-20210305223132264" style="zoom:50%;" />
...
<img src="./images/image-20210305223342800.png" alt="image-20210305223342800" style="zoom: 67%;" />
...
<img src="./images/image-20210305223838837.png" alt="image-20210305223838837" style="zoom:50%;" />
...
<img src="./images/image-20210305224148870.png" alt="image-20210305224148870" style="zoom:50%;" />
...
<img src="./images/image-20210305224552091.png" alt="image-20210305224552091" style="zoom:50%;" />
...
<img src="./images/image-20210305224852593.png" alt="image-20210305224852593" style="zoom:50%;" />
...
​	<img src="./images/image-20210305225246824.png" alt="image-20210305225246824" style="zoom:67%;" />
