...
<img src="C:\Users\10131\AppData\Roaming\Typora\typora-user-images\image-20210517142125949.png]]
...
![](./images/image-20210517153016705.png)
...
![](./images/image-20210517160024282.png)
...
- 第一个理由是来自於 Data 本身的特性
    ...
    PG 跟 Pdata,它们都是要產生图片的,那图片其实是高维空间裡面的一个低维的 Manifold(**流形**（英语：Manifolds）是可以局部[欧几里得空间.png]],怎麼知道图片是高维空间,裡面低维的 Manifold 
