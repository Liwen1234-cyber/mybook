...
![](./images/image-20230926155729468.png)
...
![1653369268550](./images/1653369268550.png)
...
![1653373887844](./images/1653373887844.png)

2、然后修改nginx的conf目录下的nginx.conf文件，配置反向代理和负载均衡：

![1653373908620](./images/1653373908620.png)
...
![1653381992018](./images/1653381992018.png)
...
* 获取锁：
  ...
  * setnx和expire合并为一个语句，避免只执行setnx后宕机
  ...
  ![](./images/image-20230927104013694.png)
...
我们利用redis 的setNx 方法，当有多个线程进入时，我们就利用该方法，第一个线程进入时，redis 中就有这个key 了，返回了1，如果结果是1，则表示他抢到了锁，那么他去执行业务，然后再删除锁，退出锁逻辑，没有抢到锁的哥们，等待一定时间后重试即可
 ...
 ![](./images/image-20230927104437637.png)![](./images/1653382830810.png)
...
![1653392181413](./images/1653392181413.png)

例如，我们要执行 redis.call('set', 'name', 'jack') 这个脚本，语法如下：

![1653392218531](./images/1653392218531.png)
...
![image-20231003230525033](./images/image-20231003230525033.png)
...
![image-20231003230754547](./images/image-20231003230754547.png)



## 5.4 分布式锁-redission锁重试和WatchDog机制

![image-20231004185259933](./images/image-20231004185259933.png)
...
![1653560986599](./images/1653560986599.png)
...
![1653577349691](./images/1653577349691.png)
...
![1653577643629](./images/1653577643629.png)

XREAD阻塞方式，读取最新的消息：

![1653577659166](./images/1653577659166.png)

在业务开发中，我们可以循环的调用XREAD阻塞方式来查询最新消息，从而实现持续监听队列的效果，伪代码如下

![1653577689129](./images/1653577689129.png)
...
![1653577801668](./images/1653577801668.png)

**创建消费者组：**
![1653577984924](./images/1653577984924.png)
key：队列名称
groupName：消费者组名称
...
![1653578211854](./images/1653578211854.png)STREAM类型消息队列的XREADGROUP命令特点：
...
![1653578992639](./images/1653578992639.png)
...
![1653579931626](./images/1653579931626.png)
...
![1653581590453](./images/1653581590453.png)
...
![1653805077118](./images/1653805077118.png)
...
![1653806140822](./images/1653806140822.png)
...
![1653806253817](./images/1653806253817.png)
...
![1653806706296](./images/1653806706296.png)
...
![1653806973212](./images/1653806973212.png)
...
![image-20240120195705841](./images/image-20240120195705841.png)
...
![1653822036941](./images/1653822036941.png)
...
![1653823145495](./images/1653823145495.png)
...
![1653824498278](./images/1653824498278.png)
...
![1653833970361](./images/1653833970361.png)
...
![1653834455899](./images/1653834455899.png)
...
![1653835784444](./images/1653835784444.png)
...
![1653836416586](./images/1653836416586.png)
...
![1653836578970](./images/1653836578970.png)
...
![1653838053608](./images/1653838053608.png)
