...
[力扣题目链接(opens new window)](https://leetcode.cn/problems/next-permutation/)
...
[力扣题目链接(opens new window)](https://leetcode.cn/problems/sort-integers-by-the-number-of-1-bits/)
