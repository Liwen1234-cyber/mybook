...
![](./images/image-20221106160753928.png)

​																		        管理端-外卖商家使用

![](./images/image-20221106160905554.png)

​																			    用户端-点餐用户使用

当我们完成该项目的学习，可以培养以下能力：

![](./images/image-20221106161507973.png)
...
![](./images/image-20221106162815172.png)
...
![](./images/image-20221106175351594.png)
...
![image-20210725234015404](./images/image-20210725234015404.png)
...
![image-20221106182912829](./images/image-20221106182912829.png)
...
![](./images/image-20221106194424735.png)
...
![](./images/image-20221106195259858.png)

**用户端原型图：**

![](./images/image-20221106195354556.png)
...
![](./images/image-20221106200821282.png)
...
![](./images/image-20221106202517738.png)
...
![](./images/image-20221106202720190.png)
...
![](./images/image-20221107092342140.png)

**2). 用 IDEA 打开初始工程，了解项目的整体结构：**

![](./images/image-20221107092540194.png)
...
- **sky-common:** 模块中存放的是一些公共类，可以供其他模块使用
  ...
  ![](./images/image-20221107093606590.png)
...
- **sky-pojo:** 模块中存放的是一些 entity、DTO、VO
  ...
  ![](./images/image-20221107094611987.png)
...
- **sky-server:** 模块中存放的是 配置文件、配置类、拦截器、controller、service、mapper、启动类等
  ...
  ![](./images/image-20221107094852361.png)
...
![](./images/image-20221107164030050.png)



当Idea中出现：

![](./images/image-20221107135819662.png)
...
![](./images/image-20221107140517031.png)

点击 创建 

![](./images/image-20221107140834161.png)
...
1. **提交文件至本地仓库**
   ...
   ![](./images/image-20221107164324396.png)

   开始提交

   ![](./images/image-20221107164654572.png)

   中间出现：点击commit

   ![](./images/image-20221107164813643.png)

2. **添加Git远程仓库地址**

   复制远程地址：

   ![](./images/image-20221107141339343.png)

   添加地址：

   ![](./images/image-20221107141634614.png)

   ![](./images/image-20221107141813693.png)

3. **推送**

![](./images/image-20221107141934132.png)

成功推送至远程仓库

![](./images/image-20221107165149915.png)
...
![](./images/image-20221107101030138.png)
...
![](./images/image-20221107102152285.png)

执行完成后，共创建出11张表

![](./images/image-20221107105103816.png)
...
![](./images/image-20221107142344642.png)
...
![](./images/image-20221107110539832.png)
...
![](./images/image-20221107151607921.png)
...
![](./images/image-20221107152112092.png)
...
![](./images/image-20221107153808368.png)
...
![image-20221107160529803](./images/image-20221107160529803.png)

**解决思路：**

1. 将密码加密后存储，提高安全性

   ![](./images/image-20221107161918913.png)

2. 使用MD5加密方式对明文密码加密

   ![](./images/image-20221107160739680.png)
...
1. 修改数据库中明文密码，改为MD5加密后的密文
   ...
   ![image-20221107161446710](./images/image-20221107161446710.png)
...
![](./images/image-20221107181446913.png)
...
![](./images/image-20221107184823104.png)

**2). 导入到YApi平台**

在YApi平台创建出两个项目

![](./images/image-20221107185304117.png)

选择苍穹外卖-管理端接口.json导入

![](./images/image-20221107185630516.png)

导入成功

![](./images/image-20221107185742061.png)
...
4. 访问测试
   ...
   ![](./images/image-20221107173033632.png)

   接口测试:测试登录功能

   ![](./images/image-20221107173137506.png)
...
![](./images/image-20221107175649468.png)
