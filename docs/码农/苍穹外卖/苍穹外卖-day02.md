...
![](./images/image-20221112172846316.png)



**菜品分类管理效果：**

![](./images/image-20221112172925354.png)
...
![](./images/image-20221111161120975.png)
...
![](./images/image-20221111162912753.png)
...
![image-20221111180159188](./images/image-20221111180159188.png)  
...
![](./images/image-20221111164002448.png)

**思考：**是否可以使用对应的实体类来接收呢？

![](./images/image-20221111164453341.png)
...
![](./images/image-20221111184934153.png)
...
![](./images/image-20221111185649636.png)
...
![](./images/image-20221111185901726.png)

**接口测试：**

![](./images/image-20221111190132481.png)

其中，请求头部含有JWT令牌

![](./images/image-20221111190248268.png)

**查看employee表：**

![image-20221111191624908](./images/image-20221111191624908.png)
...
![](./images/image-20221111192339271.png)

保存后，查看employee表

![](./images/image-20221111192446950.png)
...
![](./images/image-20221111193700895.png)

后台报错信息：

![](./images/image-20221111194049620.png)

查看employee表结构：

![](./images/image-20221111194131787.png)
...
![](./images/image-20221111195521095.png)
...
![](./images/image-20221111201922482.png)
...
![](./images/image-20221111212349365.png)
...
![](./images/image-20221111214044510.png)

查看employee表记录

![](./images/image-20221111214354053.png)
...
![](./images/image-20221112092139583.png)

提交过程中，出现提示：

![](./images/image-20221112092239578.png)

继续push:

![](./images/image-20221112092332837.png)

推送成功：

![](./images/image-20221112092427252.png)
...
![](./images/image-20221111215309289.png)
...
![](./images/image-20221111220031113.png)
...
![](./images/image-20221112101848657.png)

**响应结果：**

![](./images/image-20221112101946022.png)
...
![](./images/image-20221112102441810.png)



**输入员工姓名为zhangsan**

![](./images/image-20221112102540938.png)

不难发现，**最后操作时间格式**不清晰，在**代码完善**中解决。

![](./images/image-20221112102745437.png)
...
![](./images/image-20221112103235539.png)
...
![](./images/image-20221112103501581.png)
...
![](./images/image-20221112104305608.png)
...
![](./images/image-20221112105011214.png)
...
![](./images/image-20221112112359233.png)
...
![](./images/image-20221112112728333.png)
...
![](./images/image-20221112143142457.png)

**开始测试**

![](./images/image-20221112143316357.png)

**测试完毕后**，再次查询员工账号状态

![](./images/image-20221112143428676.png)
...
![](./images/image-20221112143552246.png)

**点击启用:**

![](./images/image-20221112143655318.png)



### 3.4 代码提交

![](./images/image-20221112143827631.png)
...
![](./images/image-20221112144731759.png)

**修改页面原型**：

注：点击修改时，数据应该正常回显到修改页面。

![](./images/image-20221112144842825.png)
...
![](./images/image-20221112145607939.png)



**2). 编辑员工信息**

![](./images/image-20221112145643769.png)
...
![image-20221112154253995](./images/image-20221112154253995.png)

开始测试

![](./images/image-20221112154411245.png)
...
修改id=4的员工信息，**name**由**zhangsan**改为**张三丰**，**username**由**张三**改为**zhangsanfeng**。
 ...
 ![](./images/image-20221112155001414.png)

查看employee表数据

![image-20221112155029547](./images/image-20221112155029547.png)
...
![](./images/image-20221112155206712.png)

对员工姓名为杰克的员工数据修改，点击修改，数据已回显

![](./images/image-20221112155430652.png)

修改后，点击保存

![](./images/image-20221112155559298.png)

### 4.4 代码提交

![](./images/image-20221112155735984.png)
...
![](./images/image-20221112160907419.png)
...
![](./images/image-20221112163011291.png)

**2). 分类分页查询**

![](./images/image-20221112163209383.png)

**3). 根据id删除分类**

![](./images/image-20221112163323554.png)

**4). 修改分类**

![](./images/image-20221112163424457.png)

**5). 启用禁用分类**

![](./images/image-20221112163557247.png)

**6). 根据类型查询分类**

![](./images/image-20221112163806318.png)
...
![](./images/image-20221112164259732.png)
...
![](./images/image-20221112170742400.png)
...
![](./images/image-20221112171252992.png)

**分类类型：**

![](./images/image-20221112171402210.png)

**启用禁用：**

![](./images/image-20221112171604991.png)

点击禁用

![](./images/image-20221112171700774.png)

**修改：**

回显

![](./images/image-20221112172117834.png)

修改后

![](./images/image-20221112172150709.png)

**新增：**

![](./images/image-20221112172356093.png)

点击确定，查询列表

![](./images/image-20221112172439370.png)

**删除：**

![](./images/image-20221112172525216.png)

删除后，查询分类列表

![](./images/image-20221112172611754.png)

删除成功

### 5.4 代码提交

![](./images/image-20221112173205048.png)
