...
![](./images/image-20221121142133307.png)
...
![](./images/image-20221121154642757.png)

**查看控制台**

通过观察控制台输出的SQL来确定公共字段填充是否完成

![image-20221121154841887](./images/image-20221121154841887.png)

**查看表**

category表中数据

![image-20221121155104152](./images/image-20221121155104152.png)
...
![](./images/image-20221121155718603.png)



**提交过程中**，出现提示：

![](./images/image-20221121155824695.png)



**继续push:**

![](./images/image-20221121160002324.png)

**推送成功：**

![](./images/image-20221121160037460.png)
...
![](./images/image-20221121164131337.png)
...
![](./images/image-20221121165033612.png)

**2. 文件上传**

![](./images/image-20221121165201319.png)



**3. 新增菜品**

![](./images/image-20221121165254961.png)
...
![](./images/image-20221121165917874.png)
...
![](./images/image-20221121174942235.png)
...
![](./images/image-20221121195440804.png)

由于没有实现菜品查询功能，所以保存后，暂且在表中查看添加的数据。

dish表：

![](./images/image-20221121195737692.png)

dish_flavor表：

![](./images/image-20221121195902555.png)
...
![](./images/image-20221121200332933.png)
...
![](./images/image-20221121201552489.png)
...
![](./images/image-20221121202019258.png)
...
![](./images/image-20221121210252403.png)

**点击发送：**

![](./images/image-20221121210333489.png)
...
![](./images/image-20221121210500188.png)
...
![](./images/image-20221121211236356.png)
...
![](./images/image-20221121211801121.png)
...
![](./images/image-20221121212436851.png)
...
![](./images/image-20221122125332084.png)

对测试菜品进行删除操作

![](./images/image-20221122125625014.png)
...
![](./images/image-20221122125841464.png)

点击批量删除

![](./images/image-20221122130016566.png)

删除失败，因为起售中的菜品不能删除。

### 4.4 代码提交

![](./images/image-20221122130426605.png)
...
![](./images/image-20221122130837173.png)
...
![](./images/image-20221122131733147.png)

**2). 修改菜品**

![](./images/image-20221122131837393.png)



![](./images/image-20221122131914533.png)
...
![](./images/image-20221122141233080.png)

点击修改，回显成功

![](./images/image-20221122141348677.png)

菜品价格修改后，点击保存

![](./images/image-20221122141456498.png)
...
![](./images/image-20221122141554380.png)
